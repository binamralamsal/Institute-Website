...
<footer>
  <div class="container">
    <div class="website-info" data-aos="fade-up">
    ...
    <div class="links" data-aos="fade-up" data-aos-delay="100">
      ...
      <ul>
        <li><a href="/"><Arrow /> About Us</a></li>
        <li><a href="/"><Arrow /> Upcoming Events</a></li>
        <li><a href="/"><Arrow /> Blog & News</a></li>
        <li><a href="/"><Arrow /> Privacy Policy</a></li>
      </ul>
    </div>
    <div class="links" data-aos="fade-up" data-aos-delay="200">
      ...
      <ul>
        ...
        <li>
          ...
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path
              d="M3 5m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2zl9 6l9 -6"
            />
          </svg>
          krishnagupt199@gmail.com
        </li>
      </ul>
    </div>
  </div>
